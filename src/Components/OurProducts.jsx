    ...
    <div className="h-auto bg-white mb-20">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-20 sm:max-w-3xl max-w-md mx-auto">
        {products.map((product, index) => (
          <div 
            key={index} 
            className="text-gray-800 shadow-lg shadow-gray-400 rounded-lg overflow-hidden h-96 flex flex-col transform transition duration-300 ease-in-out hover:scale-105 hover:shadow-gray-500"
          >
